...
class S3DISDataset(Dataset):
    ...
    def __init__(self,
        ...
        filelist_all = []
        for area in set:
            filelist_temp = glob(os.path.join(rootpath, area + "*_inst_nostuff.pth"))
            filelist_all += filelist_temp
        self.filelist = sorted(filelist_all * self.repeat)
    ...
    def __getitem__(self, index):
        ...
        coord, color, semantic_label, instance_label, room_type_id, scene = torch.load(filename)
        ...
        return (scene, coord, coord_float, feat, semantic_label, instance_label, instance_num,
