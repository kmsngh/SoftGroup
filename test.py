...
def main():
    ...
    evaluate_semantic_miou(sem_preds, sem_labels, ignore_label)
    evaluate_semantic_acc(sem_preds, sem_labels, ignore_label)
    evaluate_offset_mae(offset_preds, offset_labels, inst_labels, ignore_label)
